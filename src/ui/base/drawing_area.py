...
class DrawingArea(QGraphicsView):
    ...
    def create_new_microbloque(self, pos, relation=None, reference_structure=None):
        ...
        # Añadir pestaña de configuraciones
        config_tab = QTabWidget()
        config_tab.setStyleSheet("QTabWidget::pane { border: 1px solid #555; }")
        
        
        config_tab_content = QWidget()
        config_layout = QVBoxLayout(config_tab_content)
        ...
        config_tab.addTab(config_tab_content, "Configuraciones")

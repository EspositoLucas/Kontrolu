...
#     def calcular_tamano_topologia(self):
#         ancho = self.modelo.topologia.ancho() * ANCHO + MARGEN_HORIZONTAL * (self.modelo.topologia.ancho() + 1)
#         alto = max(self.modelo.topologia.alto() * ALTO, 600)
#         return ancho, alto

#     def ajustar_tamano_widget(self):
#         ancho, alto = self.calcular_tamano_topologia()
#         self.setMinimumSize(max(ancho, 800), max(alto, 600))

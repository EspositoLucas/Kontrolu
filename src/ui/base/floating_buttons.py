...
class FloatingButtons(QtWidgets.QGraphicsView):
    ...
    def set_buttons(self):
        ...
        self.select_button = QGraphicCircleItem(RADIO_C*6, y, RADIO_C, 'fa5s.mouse-pointer', self.padre.set_seleccion_multiple, self,toggle = True,message='Seleccionar varios micro bloques')
        self.scene.addItem(self.select_button)
        self.json_button = QGraphicCircleItem(RADIO_C*9, y, RADIO_C, 'fa5s.file-code', self.padre.vista_json, self,message='Ver JSON')
